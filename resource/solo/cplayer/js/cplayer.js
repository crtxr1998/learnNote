		...
		var m = n(16),
			...
			x = function(e) {
				...
				return r(t, e), y(t, [{
					...
					value: function() {
						var e = this.elementLinks.dropDownMenu;
						e.style.height = 2.08333 * this.options.height + "em", e.classList.remove(
					...
					value: function() {
						...
						this.elementLinks.playlist.innerHTML = "", t.forEach(function(t) {
							...
							(this.elementLinks.dropDownMenu.style.height = 2.08333 * this.options.height + "em")
					}
				}, {
